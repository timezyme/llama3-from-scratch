...
- **Status:** Milestones 1-3 complete — 7 M1 tests + 27 M2-3 tests passing, CLI inference validated against PyTorch

## Quick Reference

- **Tech Stack:** C++17, CUDA, GNU Make, Python (tooling)
- **Entry Points:** `main.cpp` (CLI inference), `tests/test.cpp` (M1 harness), `tests/test_m2m3.cpp` (M2-3 harness)
...
- [How This Project Meets The Assignment](./requirements-implementation.md) — Plain-English walkthrough of the implemented requirements
- [Source Tree Analysis](./source-tree-analysis.md) — Annotated directory tree, critical directories, entry points
- [Development Guide](./development-guide.md) — Prerequisites, build commands, testing, GCP workflow
- [CUDA Kernel Documentation](./hardware-documentation.md) — Tiled GEMM kernel architecture, optimization details
...
- [Assignment Part 1](./llm_part1.md) — Course assignment specification (Part 1)
- [Assignment Part 2](./llm_part2.md) — Course assignment specification (Part 2)
- [Mid Check-in](./mid-checkin.md) — Mid-project check-in report
- [Milestone 1 Report](./Milestone1-Report.md) — Milestone 1 completion report
...
- [Guided Tour](./presentation/index.html) — Interactive 14-step visual walkthrough
